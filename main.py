...
def check_parameters_validity(mic_num, matrix_radius, sec_mic, wave_angle):
    ...
    if sec_mic < 1 or sec_mic > mic_num:
        print("Second microphone parameter is incorrect (second microphone: " + sec_mic + ")")
        return False
...
def main():
    ...
    calculate_audio_length_arrival_shift_between_two_microphones_for_specific_doa(8, 1, 3, 270)
